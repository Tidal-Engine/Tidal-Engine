...
// Validation layers compile-time check
...
static VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(
    ...
    void* pUserData) {
    (void)messageSeverity; // Vulkan debug callback signature requirement
    (void)messageType;     // Vulkan debug callback signature requirement
    (void)pUserData;       // Vulkan debug callback signature requirement
...
void VulkanDevice::createInstance() {
    ...
    appInfo.pApplicationName = "Tidal Engine";
    appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
    appInfo.pEngineName = "Tidal Engine";
...
void VulkanDevice::hasGlfwRequiredInstanceExtensions() const {
